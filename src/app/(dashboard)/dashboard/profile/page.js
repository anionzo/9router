  ...
  const restoreFromCloud = async (key) => {
    ...
    try {
      ...
      if (settingsRes.ok) {
        ...
        setProxyForm({
          outboundProxyEnabled: nextSettings?.outboundProxyEnabled === true,
          outboundProxyUrl: nextSettings?.outboundProxyUrl || "",
          outboundNoProxy: nextSettings?.outboundNoProxy || "",
        });
      }
        ...
        <Card>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-bg border border-border gap-3 flex-wrap">
              ...
              <Button variant="secondary" icon="cloud_upload" onClick={backupToCloud} loading={dbCloudLoading}>
                Backup to Cloud
              </Button>
            </div>
                  ...
                  {cloudBackups.length > 3 && (
                    <div className="pt-1">
                      <Button
                        ...
                        disabled={dbCloudLoading || schedulerRunningNow}
                      >
                        {showAllCloudBackups ? "Show Less" : `Show More (${cloudBackups.length - 3})`}
                      </Button>
                    </div>
                  )}
                </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-text-muted">Turn request detail recording on/off globally</p>
              </div>
            ...
            <div className={cn("flex flex-col gap-4", !observabilityEnabled && "opacity-60")}>
              <div className="flex items-center justify-between">
                ...
                <Input
                  ...
                  onChange={(e) => updateObservabilitySetting("observabilityMaxRecords", parseInt(e.target.value, 10))}
              ...
              <div className="flex items-center justify-between">
                ...
                <Input
                  ...
                  onChange={(e) => updateObservabilitySetting("observabilityBatchSize", parseInt(e.target.value, 10))}
                  disabled={loading || !observabilityEnabled}
                  className="w-28 text-center"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Input
                  ...
                  onChange={(e) => updateObservabilitySetting("observabilityFlushIntervalMs", parseInt(e.target.value, 10))}
                  disabled={loading || !observabilityEnabled}
                  className="w-28 text-center"
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Input
                  ...
                  onChange={(e) => updateObservabilitySetting("observabilityMaxJsonSize", parseInt(e.target.value, 10))}
                  disabled={loading || !observabilityEnabled}
                  className="w-28 text-center"
                />
              </div>
